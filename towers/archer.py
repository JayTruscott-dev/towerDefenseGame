...
for i in range(1,4,1):
    imgs.append(pygame.transform.scale(pygame.image.load(os.path.join("media/Towers/2-ArcherTower", "Archer-" + str(i) + ".png")), (50,90)))
...
class Archer(Tower):
    def __init__(self, x, y):
        ...
        self.arrow_imgs.append(pygame.transform.rotate(pygame.image.load(os.path.join("media/Towers/misc", "archerarrow3.png")), 30))
        self.move_x = 10
        self.move_y = 10
        ...
        # MENU
        self.menu = Menu(self, self.x, self.y, menu_bg, [1000, 1250, "MAX"])
    ...
    def change_range(self, r):
        """ Changes the range of the archer tower
            Params: r (int): new RNG for the tower
            Return: None
        """
        self.RNG = r
    
    def change_damage(self, d):
        """ Changes the damage of the archer tower
            Params: d (int): new DMG for the archer tower
            Return: None
        """
        self.DMG = d
